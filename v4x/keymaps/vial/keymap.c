...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT( //Alphabet
		...
		KC_TAB, KC_A, KC_S, KC_D, KC_F, KC_G,                       XXXXXXX,    XXXXXXX,     KC_H,  KC_J, KC_K, KC_L, KC_SCLN, KC_ENT, 
		KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B,                      LGUI(KC_ESC), KC_MPLY,   KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_DEL,
	...
	[1] = LAYOUT( //Numpad and Punctuation
		...
		KC_LGUI, KC_1, KC_2, KC_3, KC_EQL, KC_ASTR,                 XXXXXXX,    XXXXXXX,     KC_BSLS, KC_AT, KC_CIRC, KC_LPRN, KC_RPRN, KC_UNDS,  
		XXXXXXX, XXXXXXX, XXXXXXX, KC_LCTL, TO(0), LSFT_T(KC_BSPC), XXXXXXX,    XXXXXXX,     KC_PENT, LGUI(KC_SPC), KC_LALT, XXXXXXX, XXXXXXX, XXXXXXX), 
