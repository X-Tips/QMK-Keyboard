...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[0] = LAYOUT(
		LCTL(KC_Z), KC_PPLS, KC_7,          KC_8, KC_9,
		LCTL(KC_X), KC_PMNS, KC_4,          KC_5, KC_6, 
		LCTL(KC_C), KC_PAST, KC_1,          KC_2, KC_3,
		LCTL(KC_V), KC_PSLS, LT(1, KC_ENT), KC_0, KC_PDOT), 

	[1] = LAYOUT(
		LCTL(KC_Y), KC_LRCBR, KC_HOME, KC_UP,   KC_END, 
		LCTL(KC_S), KC_LRBRC, KC_LEFT, KC_EQL,  KC_RGHT, 
		LCTL(KC_A), KC_LRPRN, KC_PGUP, KC_DOWN, KC_PGDN, 
		KC_ESC,     KC_TAB,   TO(0),   KC_BSPC, KC_DEL), 
