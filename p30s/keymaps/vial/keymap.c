...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[6] = LAYOUT( //Software hotkeys
		...
		MEH(KC_Z), RGB_TOG, MEH(KC_C), MEH(KC_V), MEH(KC_B), MEH(KC_N), MEH(KC_M), MEH(KC_COMM), MEH(KC_BSPC), MO(7)),
	...
	[7] = LAYOUT( //KB Bootkey & Sys Reboot,Shutdown & Others
		...
		HYPR(KC_A), HYPR(KC_S), HYPR(KC_D), HYPR(KC_F), HYPR(KC_G), HYPR(KC_H), HYPR(KC_J), HYPR(KC_K),  HYPR(KC_L),   HYPR(KC_ENT),
		HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B), HYPR(KC_N), QK_BOOT,    MEH(KC_LBRC),MEH(KC_RBRC), TO(0))
};
