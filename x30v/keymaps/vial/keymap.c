...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT( //Number & Punctuation                                                                                                         
		...
		KC_LGUI, KC_LALT, KC_LCTL, TO(0), LSFT_T(KC_PENT),                        RAG(KC_6), LGUI(KC_SPC), RAG(KC_8), RAG(KC_9), RAG(KC_0)),       
	...
	[3] = LAYOUT( //L:Quickly input -- R:Mouse & Webbrower Hotkeys                                                                               
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 															XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
		XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 															XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
		HYPR(KC_Q), HYPR(KC_W), HYPR(KC_E), HYPR(KC_R), HYPR(KC_T),               HYPR(KC_Y), HYPR(KC_U), KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2,        
		HYPR(KC_A), HYPR(KC_S), HYPR(KC_D), HYPR(KC_F), HYPR(KC_G),               HYPR(KC_H), HYPR(KC_J), KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT,     
		HYPR(KC_Z), HYPR(KC_X), HYPR(KC_C), HYPR(KC_V), HYPR(KC_B),               HYPR(KC_N), HYPR(KC_M), KC_MS_BTN4, KC_MS_BTN5, KC_MS_WH_UP,     
		HYPR(KC_1), HYPR(KC_2), HYPR(KC_3), HYPR(KC_4), HYPR(KC_5),               HYPR(KC_6), HYPR(KC_7), TO(0), KC_MS_BTN3, KC_MS_WH_DOWN),       
